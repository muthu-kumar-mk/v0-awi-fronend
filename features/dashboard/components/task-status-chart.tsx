      ...
      <div className="flex-1 w-full">
        <ResponsiveContainer width="100%" height="70%">
          ...
          >
            ...
            <Bar dataKey="Yet to Start" stackId="a" fill={statusColors["Yet to Start"]} radius={8} />
            <Bar dataKey="Hold" stackId="a" fill={statusColors["Hold"]} radius={8} />
            <Bar dataKey="Paused" stackId="a" fill={statusColors["Paused"]} radius={8} />
            <Bar dataKey="In Progress" stackId="a" fill={statusColors["In Progress"]} radius={8} />
